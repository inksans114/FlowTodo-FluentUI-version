...
FluentPage {
    ...
    function openEditor(id) { var router = nav(); if (router) router.push(Qt.resolvedUrl("ProjectEditorPage.qml"), {projectId: id}) }
    function openPrep(id) { var router = nav(); if (router) router.push(Qt.resolvedUrl("ProjectPrepPage.qml"), {projectId: id}) }
